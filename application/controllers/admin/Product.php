    ...
    function add()
    {
        ...
        if($this->input->post())
        {
            ...
            if($this->form_validation->run())
            {
                ...
                $arrayPriceSize = $_POST['price_size'];

                $arrPriceSizeFinal = array();
                foreach($arraySize as $key => $val){
                    $arrPriceSizeFinal[$key]['size'] = $arraySize[$key];
                    $arrPriceSizeFinal[$key]['price_size'] = $arrayPriceSize[$key];
                }
                //echo "<pre>"; print_r($arrPriceSizeFinal); die;
                $size_price = json_encode($arrPriceSizeFinal);
                //echo  json_encode($size_price);
