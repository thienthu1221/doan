                                            ...
                                            <select name="catalog">
                                                ...
                                                <?php foreach ($catalogs as $row): ?>
                                                    <?php if (count($row->subs) > 1): ?>
                                                        <optgroup style="font-weight: bolder" label="<?php echo $row->name ?>">
                                                            <?php foreach ($row->subs as $sub): ?>
                                                                <option style="font-style: oblique; font-weight: bold" value="<?php echo $sub->id ?>" <?php echo ($this->input->get('catalog') == $sub->id) ? 'selected' : '' ?>> <?php echo $sub->name ?>
            ...
            <tbody class="list_item">
                <?php foreach ($list as $row): ?>
                    <tr class="row_<?php echo $row->id ?>">
                        ...
                        <?php 
                        $sizePrice = json_decode($row->size_price);
                        //var_dump($sizePrice);
                        //echo $sizePrice[1]->price_size;
                        ...
                        <td class="textR">
                            <?php if($row->price == 0):?>
                            <b style="color:red"><?php echo $a?> đ</b>
                            <?php else: ?>
                        ...
                        <td class="option textC">
                            <a title="Xem chi tiết sản phẩm" class="tipS" target="_blank" href="">
