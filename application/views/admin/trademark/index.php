                ...
                <tr>
                    <td colspan="7">
                        <div class="list_action itemActions">
                            <a href="#submit" id="submit" class="button blueB" url="<?php echo admin_url('trademark/delete_all') ?>">
            ...
            <tbody>
                <?php foreach ($list as $row): ?>
                    <tr class="row_<?php echo $row->id ?>">
                        ...
                        <td class="option">
                            <a href="<?php echo admin_url('trademark/edit/' . $row->id) ?>" title="Chỉnh sửa" class="tipS ">
                                <img src="<?php echo public_url('admin') ?>/images/icons/color/edit.png" />
                            </a>
                            <a href="<?php echo admin_url('trademark/delete/' . $row->id) ?>" title="Xóa" class="tipS verify_action" >
